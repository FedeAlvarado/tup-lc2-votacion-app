...
const filtrar = async () => {
    try {
        ...
        console.log(data)
         //CAMBIO TITULO Y PATH

        titulo.innerHTML = "Elecciones " + añoSelect.value + " | " + cargoSeleccionado.Cargo
        ...
        tituloProvincia.textContent = distritoSeleccionado.Distrito.toUpperCase()
...
function cambioHTML(data){
    ...
    cantMesas.textContent = estadoRecuento.mesasTotalizadas

    cantElectores = document.getElementById("cantElectores")
    cantElectores.textContent = estadoRecuento.cantidadElectores
