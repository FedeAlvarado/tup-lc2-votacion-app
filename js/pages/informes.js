...
function generarTablaInformes(informes) {
    ...
    console.log("informes desde func", informes)
    const informesTableBody = document.getElementById("tabla-informes");
    ...
    informes.forEach(informe => {
        console.log("mapa",mapasProv[informe[13]])
        console.log("informe", informe)
        console.log((!validarInforme(informe)))
        if (!validarInforme(informe)) return;
        html += `<tr class="tabla-body" id="tabla-body">
            <td class="provincia">
                <div class="flex-td">`;
        html += `${mapasProv[informe[13]]}`;
        html += `</div>
            </td>
            <td class="eleccion">
                <div class="flex-td">
                    <p class="texto-elecciones-chico">Elecciones ${informe[0]} | ${informe[2]}</p>
                    <p class="texto-path-chico">${informe[0]} > ${informe[2]} > ${informe[3]} > ${informe[4]}</p>
                </div>
            </td>
        ...
        informesTableBody.innerHTML = html;
    });
}
